...
// Definicion de getter y setter de los componentes visuales del formulario
    ...
    public void setTxtNombreModelo(JTextField txtNombreModelo) {
        this.txtNombreModelo = txtNombreModelo;
    }
    ...
    */
    public JComboBox getCmbNombreModelo() {
        return cmbNombreModelo;
    }

    public void setCmbNombreModelo(JComboBox cmbNombreModelo) {
        this.cmbNombreModelo = cmbNombreModelo;
    }
...
// Constructores del formulario 
    ...
    public void viewCamposEnabled(Boolean tipo) {
        ...
        txtNombreModelo.setEnabled(tipo);
        //this.cmbTipoProyecto.setEnabled(tipo);
        
    }

    private void viewDenominacionVisible(Boolean tipo){
        txtNombreModelo.setVisible(tipo);
        cmbNombreModelo.setVisible(!tipo);
    }
    ...
    */
    ...
    public void cargarComboModel(){
        this.gestorVista.setModelModelo(cmbNombreModelo);
    }
   ...
   public void extraView() {
    ...
    private void initComponents() {
        ...
        cmbNombreModelo = new javax.swing.JComboBox();
        ...
        cmbNombreModelo.setFont(new java.awt.Font("Bodoni MT", 0, 14)); // NOI18N
        cmbNombreModelo.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmbNombreModeloItemStateChanged(evt);
            }
        });
        jPanel1.add(cmbNombreModelo);
        cmbNombreModelo.setBounds(110, 50, 460, 23);
        ...
        txtNombreModelo.setFont(new java.awt.Font("Bodoni MT", 0, 14)); // NOI18N
        txtNombreModelo.setDisabledTextColor(new java.awt.Color(0, 0, 0));
    ...
    private void cmbNombreModeloItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbNombreModeloItemStateChanged
        if (this.getGestorVista().isEmpty(cmbNombreModelo)) {
            this.viewBuscarPrincipalEnter();
        }
        else  {
            this.getGestorVista().setModel(cmbNombreModelo);
            this.viewActualizar();
            this.viewDenominacionVisible(false);
        }
}//GEN-LAST:event_cmbNombreModeloItemStateChanged
    ...
    private javax.swing.JComboBox cmbNombreModelo;
